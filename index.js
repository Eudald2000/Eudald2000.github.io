...
// Assigna a estos id los archivos html correspondientes
// y al hacer click salta el evento que carga el contenido
const secciones = {
    sobreMi: 'presentacion.html',
...
Object.entries(secciones).forEach(([id, archivo]) => {
    document.getElementById(id)?.addEventListener('click', () => loadContent(archivo));
});
